Данный проект направлен на создание и обучение модели на основе архитектуры YOLO для автоматической детекции и распознавания показаний счетчиков на изображениях. 
